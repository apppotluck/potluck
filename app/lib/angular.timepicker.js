angular.module('dnTimepicker', ['ui.bootstrap']).directive('dnTimepicker', ['$compile', '$parse', '$position', '$document', '$filter', function($compile, $parse, $position, $document, $filter) {
